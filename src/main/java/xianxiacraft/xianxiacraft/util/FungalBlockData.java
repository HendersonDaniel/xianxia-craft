...
public class FungalBlockData {
    ...
    private static final ArrayList<Material> fungalToStem = new ArrayList<Material>(Arrays.asList(Material.ACACIA_LOG,Material.BIRCH_LOG,Material.JUNGLE_LOG,Material.MANGROVE_LOG,Material.DARK_OAK_LOG,Material.OAK_LOG,Material.SPRUCE_LOG));
    private static final ArrayList<Material> fungalToMushroomFlower = new ArrayList<Material>(Arrays.asList(Material.POPPY,Material.OXEYE_DAISY,Material.ORANGE_TULIP,Material.PINK_TULIP,Material.CORNFLOWER,Material.ALLIUM,Material.RED_TULIP,Material.WHITE_TULIP,Material.DANDELION,Material.AZURE_BLUET));
